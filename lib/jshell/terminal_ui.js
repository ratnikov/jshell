...
JShell.TerminalUI.prototype = new JShell;

JShell.TerminalUI.prototype.newLine = function() {
...
JShell.TerminalUI.prototype.invoke = function(line) {
...
JShell.TerminalUI.prototype.noCommandFound = function(name) {
  this.stdout.write("Command not found: " + name +". Type 'cmdlist' for list of commands.");
};

JShell.TerminalUI.prototype.clear = function() {
